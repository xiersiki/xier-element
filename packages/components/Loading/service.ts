...
import { useZIndex } from "@xier-element/hooks";
import LoadingComp from "./Loading.vue";
import { delay, isNil, isString } from "lodash-es";

const RELATIVE_CLASS = "xr-loading-parent--relative" as const;
const HIDDEN_CLASS = "xr-loading-parent--hiden" as const;
const LOADING_NUMB_KEY = "xr-loading-numb" as const;

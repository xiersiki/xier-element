...
import { DROPDOWN_CTX_KEY } from './constantkeys';
import type { DropDownItemProps, DropdownContext } from './types'
...
<template>
    <div class="xr-dropdown__item" @click="dropDownContext?.handleItemClick?.(props.command!)" :class="{

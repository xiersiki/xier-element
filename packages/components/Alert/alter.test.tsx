...
describe("Alert.vue", () => {
    ...
    it("should emit close event when close icon is clicked", () => {
        ...
        wrapper.findAllComponents(Icon)[1].trigger("click");
    ...
    it("should support centering text", () => {
        ...
        //class
        const rootNode = wrapper.find(".xr-alert");
    ...
    it("should not render close icon when closable is false", () => {
        ...
        expect(wrapper.find(".xr-alert__close").exists()).toBe(false);
    });
    ...
    it("should toggle visibility when open and close methods are called", async () => {
        ...
        expect(wrapper.find(".xr-alert").attributes().style).toBe("display: none;");
        await wrapper.vm.open();
        expect(wrapper.find(".xr-alert").attributes().style).toBe("");
    });
});
